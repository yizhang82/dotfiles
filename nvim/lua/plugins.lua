...
return require("packer").startup(function(use)
  ...
  -- Keybindings
  vim.api.nvim_set_keymap('n', '<C-h>', '<cmd>NavigatorLeft<CR>', { noremap = true, silent = true })
  vim.api.nvim_set_keymap('n', '<C-l>', '<cmd>NavigatorRight<CR>', { noremap = true, silent = true })
  vim.api.nvim_set_keymap('n', '<C-k>', '<cmd>NavigatorUp<CR>', { noremap = true, silent = true })
  vim.api.nvim_set_keymap('n', '<C-j>', '<cmd>NavigatorDown<CR>', { noremap = true, silent = true })
